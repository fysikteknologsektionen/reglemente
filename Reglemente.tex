...
\item Revisor, SAMO, eller ledamot av valberedningen kan ej vara medlem av sektionsstyrelsen.
...
\item Kallelse till styrelsemöte skall senast två dagar innan mötet skickas till ordinarie ledamöter av sektionsstyrelsen, medlem av kommitté och studienämnd, revisorer, SAMO samt övriga berörda funktionärer.
...
\item Revisor, studerandearbetsmiljöombud och ledamöter av valberedningen har närvaro-, yttrande- och förslagsrätt
...
\item[att] följa de av sektionen upprättade arbetsordningarna.
  ...
  \item Det åligger sektionsstyrelsens ledamot:
    \begin{description}
    ...
    \end{description}
      \item[att] hjälpa övriga ledamöter i sekitionsstyrelsens verksamhet.
...
\begin{enumerate}[\thesubsection .1]
  ...
  antal\-et och består av sektionsstyrelsens ledamot samt två SAMO med
  särskilt ansvar för arbetsmiljön på utbildningsprogrammen Teknisk
  Fysik respektive Teknisk Matematik. Dessa två SAMO skall vara oberoende och anses förtroendevalda.
  \item SAMO är en förtroendepost.
\item Studerandearbetsmiljöombud för Teknisk Matematik skall vara student på nämnda program.

\item Studerandearbetsmiljöombud för Teknisk Fysik skall vara student på nämnda program.

\item Studerandearbetsmiljöombud för programmen Teknisk Matematik och Teknisk Fysik får ej vara medlem av sektionskommitté, nämnd på sektionen, valberedningen eller sektionsstyrelsen.
