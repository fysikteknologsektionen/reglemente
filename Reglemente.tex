...
\item Kallelse till styrelsemöte skall senast två dagar innan mötet skickas till ordinarie ledamöter av sektionsstyrelsen, medlem av kommitté och nämnd, revisorer, talmanspresidiet samt övriga berörda sektionsföreningsmedlemmar och funktionärer.
...
\item[att] följa de av sektionen upprättade arbetsordningarna.
  ...
  \item Det åligger sektionsstyrelsens  kassör:
    \begin{description}
      ...
      \item[att] fortlöpande kontrollera kommittéernas samt eventuella sektionföreningars räkenskaper och bokför\-ing.
      \item[att] teckna sektionens firma.
...
Studienämnden har en verksamhet som går från 1 juli till 30 juni.
...
\begin{enumerate}[\thesubsection .1]
    ...
    \item Det åligger ekonomisk ansvarig:
    \begin{description}
     \item[att] mot revisorerna och sektionskassören kontinuerligt redovisa för den ekonomiska situationen.
    \end{description}
\end{enumerate}
...
\begin{enumerate}[\thesubsection .1]
    ...
    \item FIF har en verksamhet som går från 1 april till 31 mars.
    ...
    \item Det åligger FIF:s ordförande:
        \begin{description}
          ...
          föreningar på sektionen samt tillse att kontakt med andra
          sektioners idrotts\-före\-ning\-ar uppehålls.
    ...
    \item Det åligger FIF:s övriga ledamöter:
    \begin{description}
      \item[att] hjälpa FIF:s ordförande att efterfölja FIF:s åligg\-and\-en.
    \end{description}
