...
\usepackage{CJKutf8} % Så att Monobi kan skrivas på japanska
...
\tempsection{Sektionsmötet}
	\subsection{Kallelse}
		...
		\pgf Kallelse till sektionsmöte skall tillsändas sektionsmedlemmar, revisorer, inspektor och kårstyrelsen.
	...
	\subsection{Slutgiltig föredragningslista}
		...
		\pgf Slutgiltig föredragningslista till sektionsmöte skall tillsändas sektionsmedlemmar, revisorer, inspektor samt kårstyrelsen.
	...
	\subsection{Talmanspresidiet}
		...
		\pgf Vid talmannens frånvaro övertar vice talman dennes åliggande och befogenheter. 
		\pgf Under sektionsmöten skall medlemmar av talmanspresidiet tilltalas Herr/Fru talman/vice talman/sekreterare. 
...
\tempsection{Sektionsstyrelsen}
	...
	\subsection{Styrelsemöten}
		...
		\pgf Kallelse till styrelsemöte skall senast två dagar innan mötet skickas till ordinarie ledamöter av sektionsstyrelsen, medlem av kommitté och nämnd, revisorer, talmanspresidiet samt övriga berörda sektionsföreningsmedlemmar och funktionärer.

		\pgf Protokoll från styrelsemöten anslås via sektionens officiella kommunikationskanaler.

		\pgf Ordinarie ledamöter av sektionsstyrelsen har närvaro-, yttrande-, förslags- och rösträtt. 

		\pgf Talmannen har närvaro-, yttrande- och förslagsrätt. Vid frågor som direkt berör sektionsmöten har talmannen även rösträtt. 
	...
	\subsection{Åligganden}
		\pgf Det åligger sektionsstyrelsen:
			\begin{description}
				...
				\item[att] varje år tillsammans med studienämnden utse sektionens representanter i styrelser och kommittéer inom högskolan. Dock krävs för ledamöterna i Programrådet godkännande från sektionsmötet.
				\item[att] granska och utse phaddergruppsansvariga under inrådan av FnollK.
		...
		\pgf Det åligger sektionsstyrelsens skyddsombud:
			\begin{description}
				\item[att] vara sektionens studerandearbetsmiljöombud enligt punkt 10.6 ''Fysikteknologsektionens Studerandearbetsmiljöombud'' samt vara Fysikteknologsektionens jämlikhetsansvarige. SAMO har i sitt uppdrag tystnadsplikt.
...
\tempsection{Kommittéer}
	...
	\subsection{FnollK}
		...
		\pgf Verksamheten drivs på ideell basis, d.v.s. den ska gå jämnt upp. Dock skall det finnas ett visst utrymme för ersättning i form av representation. Eventuellt överskott tillfaller sektionen. 
		...
		\pgf Det åligger FnollK:s kassör:
			\begin{description}
				\item[att] sköta och tillsammans med FnollKs ordförande ansvara för FnollKs ekonomi.
...
\tempsection{Sektionsföreningar}
	...
	\subsection{Åligganden}
		...
		\pgf Det åligger ekonomisk ansvarig:
			\begin{description}
				\item[att] mot revisorerna och sektionskassören kontinuerligt redovisa för den ekonomiska situationen.
			\end{description}
	...
	\subsection{Fysikteknologsektionens Idrottsförening, FIF}
		\pgf FIF består av följande poster:
			\begin{itemize}
				...
				\item 0--7 ledamöter.
			\end{itemize}
            Där ordförande och kassör är förtroendeposter.

		\pgf FIF har en verksamhet som går från 1 april till 31 mars.
	...
	\subsection{Foton}
		...
		\pgf Det åligger Foton:
			\begin{description}
				...
				\item[att] i samband med arbetsmässor arrangera porträttfotografering.
...
\tempsection{Funktionärer}
	...
	\subsection{Fysikteknologsektionens Dumvästinnehavare}
		...
		\pgf Reglemente angående Dumvästens utdelande:
	...
	\subsection{Fysikteknologsektionens Balnågonting}
		...
		\pgf Balnågonting har 0-5 medlemmar samt en representant vardera från FnollK, F6 och Djungelpatrullen.

	\subsection{Game Boy}
        \pgf Game Boys syfte är att ta hand om de sällskapsspel som finns på Focus, samt främja brädspelsverksamheten på Fysikteknologsektionen.

		\pgf Game Boy består av 0--6 Game Boys.
...
\tempsection{Styrdokument}
	...
	\subsection{Ändrings- och tolkningsfrågor}
		...
		\pgf Vid konflikt med Fysikteknologsektionens övriga styrdokument har reglementet företräde.
